...
class _DoctorDashboardState extends State<DoctorDashboard> {
  ...
  Future<void> _loadWards() async {
    // Use optimized getDoctorWards() instead of loading all patients
  ...
  Widget _buildBedsList(String doctorId) {
    return StreamBuilder<List<PatientModel>>(
      stream: _databaseService.getPatientsForDoctor(doctorId),
      builder: (context, snapshot) {
        ...
        // Filter by selected ward (already sorted by server)
            ...
            return _BedCard(
              ...
              onTap: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) =>
                        PatientDetailView(patient: patients[index]),
                  ),
                );
              },
            );
